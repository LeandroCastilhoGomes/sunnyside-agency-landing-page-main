# Frontend Mentor - página inicial da agência Sunnyside

![Visualização do design para o desafio de codificação da página de destino da agência Sunnyside](./design/desktop-preview.jpg)
...
Este desafio se concentra principalmente em HTML e CSS. Há um pouquinho de JS incluído para a alternância de navegação móvel. Mas você também pode optar por fazer isso sem JS!
